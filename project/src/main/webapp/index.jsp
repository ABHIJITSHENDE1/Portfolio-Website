 ...
 <%@include file="message.jsp" %>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
            <a class="navbar-brand" href="index.html"><i class='uil uil-user'></i>Abhijeet</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="admin.jsp" class="nav-link"><span data-hover="Admin Panel">Admin Panel</span></a>
                    </li>
                </ul>
                        ...
                        <h1 class="animated animated-text">
                            <span class="mr-2">Hey folks, I'm</span>
                                <div class="animated-info">
                                    <span class="animated-item">Abhijeet Shende</span>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-lg-5 col-12">
            <div class="google-map w-100">
            	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.041982059465!2d73.94852407473434!3d18.48175747035953!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2e984f0a0051d%3A0x36672b52827b28e0!2sPapadewasti!5e0!3m2!1sen!2sin!4v1693429539274!5m2!1sen!2sin"
            ...
            <div class="contact-info d-flex justify-content-between align-items-center py-4 px-lg-5">
                <div class="contact-info-item">
                  ...
                  <p class="footer-text mb-0">098 502 91849</p>
                  <p><a href="mailto:hello@company.co">shendeabhijeet298@gmail.com</a></p>
                </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-12 col-12">                                
                        ...
                        <p class="copyright-text text-center">Designed by <a rel="nofollow" href="https://www.facebook.com/tooplate">Abhijeet Shende</a></p>
                    </div>
